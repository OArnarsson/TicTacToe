...
2. Execute the command: <code> gradlew build</code>
    * <code>gradlew build</code> will call on Travis, Travis will run test cases and if all test cases are passed, Travis will allow the game to start.
